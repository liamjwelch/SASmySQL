			...
			<table>
				<tbody>
					<tr>
						...
						<td><form:input path="student.studentID" /><br>
						<form:errors path="student.studentID" cssClass="error" id="error" /></td>
					</tr>

					<tr>
						<td><label>Course</label></td>
						<td><form:input path="course.courseID" /><br>
						<form:errors path="course.courseID" cssClass="error" id="error" /></td>
					</tr>
